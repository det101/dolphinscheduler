...
public class TaskDefinitionController extends BaseController {
    ...
    public Result queryTaskDefinitionVersions(@Parameter(hidden = true) @RequestAttribute(value = Constants.SESSION_USER) User loginUser,
        ...
        result.setData(SensitivePropertyUtils.copyAndMaskTaskDefinitionPage(pageInfo));
        return result;
    }
    ...
    public Result<TaskDefinitionVO> queryTaskDefinitionDetail(@Parameter(hidden = true) @RequestAttribute(value = Constants.SESSION_USER) User loginUser,
        ...
        return Result.success(SensitivePropertyUtils.copyAndMaskTaskDefinition(taskDefinitionVO));
    }
