...
public class CommandEngine extends BaseDaemonThread implements AutoCloseable {
        ...
        while (flag) {
            try {
                ...
                for (Command command : commands) {
                    CompletableFuture<Void> completableFuture = bootstrapCommand(command, command.getWorkflowInstanceId())
    ...
    private CompletableFuture<IWorkflowExecutionRunnable> bootstrapCommand(Command command, int workflowInstanceId) {
        return supplyAsync(() -> {
